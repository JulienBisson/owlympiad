...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'ownerId', targetEntity: Game::class, orphanRemoval: true)]
    private Collection $games;

    #[ORM\OneToMany(mappedBy: 'userId', targetEntity: Booking::class)]
    private Collection $bookings;

    #[ORM\ManyToMany(targetEntity: Exchange::class, mappedBy: 'userId')]
    ...
    public function removeGame(Game $game): static
    {
        if ($this->games->removeElement($game)) {
            ...
            if ($game->getOwnerId() === $this) {
                $game->setOwnerId(null);
            }
        }
